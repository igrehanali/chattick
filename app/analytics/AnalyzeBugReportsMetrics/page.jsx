            ...
            <div className="analytics-container">
                ...
                <div className="metrics-summary">
                    <div className="metric-card">
                        <h3>Total Bugs</h3>
                        <p>{bugsData.monthlyBugs.reduce((acc, curr) => acc + curr.total, 0)}</p>
                    </div>
                    <div className="metric-card">
                        <h3>Resolved Bugs</h3>
                        <p>{bugsData.monthlyBugs.reduce((acc, curr) => acc + curr.resolved, 0)}</p>
                    </div>
                    <div className="metric-card">
                        <h3>Open Critical Bugs</h3>
                        <p className="critical">{bugsData.severityMetrics.open.find(s => s.severity === "Critical").count}</p>
                    </div>
                    <div className="metric-card">
                        <h3>Avg Resolution Time</h3>
                        <p>{Math.round(bugsData.resolutionTime.reduce((acc, curr) => acc + curr.avgDays, 0) / 3)} days</p>
                    </div>
                </div>
                ...
                <div className="charts-grid">
                    ...
                    <div className="chart-card">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={bugsData.monthlyBugs} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="month" />
                                <YAxis />
                                <Tooltip />
                                <Legend />
                                <Line type="monotone" dataKey="total" stroke="#8884d8" name="Total Bugs" />
                                <Line type="monotone" dataKey="resolved" stroke="#82ca9d" name="Resolved Bugs" />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                    ...
                    <div className="chart-card">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={bugsData.platformDistribution.monthly} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="month" />
                                <YAxis />
                                <Tooltip />
                    ...
                    <div className="chart-card">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={bugsData.resolutionTime} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                    ...
                    <div className="chart-card">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart data={bugsData.severityMetrics.open} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                ...
                                <Tooltip />
                                <Legend />
                                <Bar dataKey="count" fill="#8884d8" name="Open Bugs" yAxisId="left" />
                                <Line type="monotone" dataKey="avgDaysOpen" stroke="#ff7300" name="Avg Days Open" yAxisId="right" />
                            </ComposedChart>
                        </ResponsiveContainer>
                    </div>
                    ...
                    <div className="chart-card">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={bugsData.severityMetrics.backlog} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="severity" />
                                <YAxis />
                                <Tooltip />
