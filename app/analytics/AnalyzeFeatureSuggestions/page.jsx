      ...
      <div className="analytics-container">
        ...
        <div className="metrics-summary">
          <div className="metric-card">
            ...
            <p>
              {suggestionsData.monthlySubmissions.reduce(
          ...
          <div className="metric-card">
            ...
            <p className="implemented">
              {suggestionsData.monthlySubmissions.reduce(
                (acc, curr) => acc + curr.implemented,
                0
              )}
            </p>
          </div>
          ...
          <div className="metric-card">
            <h3>Total Votes</h3>
            <p>
              {suggestionsData.topSuggestions.reduce(
        ...
        <div className="charts-grid">
          ...
          <div className="chart-card">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart
                data={suggestionsData.monthlySubmissions}
          ...
          <div className="chart-card">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={suggestionsData.topSuggestions}
                layout="vertical"
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                <Pie
                  ...
                  label
                >
                  {suggestionsData.categoryMetrics.distribution.map(
                    (entry, index) => (
                      <Cell
                        key={`cell-${index}`}
          ...
          <div className="chart-card">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={suggestionsData.categoryMetrics.implementationRates}
                margin={{ top: 5, right: 30, left: 20, bottom: 5 }}
              >
                <CartesianGrid strokeDasharray="3 3" />
